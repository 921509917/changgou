package com.duan.order.feign;
import com.duan.entity.Result;
import com.duan.order.pojo.ReturnOrderItem;
...
public interface ReturnOrderItemFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) ReturnOrderItem returnOrderItem, @PathVariable int page,
