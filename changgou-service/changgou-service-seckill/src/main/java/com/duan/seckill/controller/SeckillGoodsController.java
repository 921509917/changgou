...
public class SeckillGoodsController {
     ...
     * @return
     */
    @GetMapping(value = "/search/{page}/{page_size}")
    public Result<PageInfo> findPage(@PathVariable int page, @PathVariable int page_size) {
        //调用SeckillGoodsService实现分页查询SeckillGoods
        PageInfo<SeckillGoods> pageInfo = seckillGoodsService.findPage(page, page_size);
